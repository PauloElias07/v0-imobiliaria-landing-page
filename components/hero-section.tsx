      ...
      <div className="container mx-auto px-6 relative z-10 pt-24 pb-12">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight mb-6 text-balance"
          >
            Corretor Especializado em Apartamentos de Alto Padrão
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl font-serif text-white/95 mb-6 text-balance"
          >
            Encontre o apartamento ideal nas melhores regiões de São Paulo
          </motion.p>
          ...
          >
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground px-8 py-4 rounded-lg font-semibold hover:bg-accent/90 transition-all duration-200 hover:scale-105"
            >
              <WhatsAppIcon />
              Falar no WhatsApp
            </Link>
            <Link
              href="#imoveis"
              className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/20 transition-all duration-200 border border-white/20"
            >
