      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-serif font-bold mb-4">Roberto Elias</h3>
            <p className="text-primary-foreground/70 mb-6 max-w-md leading-relaxed">
              Corretor de imóveis especializado em apartamentos nas melhores regiões 
              da zona sul de São Paulo. Atendimento personalizado e suporte completo 
          ...
          <div>
            ...
            <ul className="space-y-3 text-primary-foreground/70">
              <li>
                <Link href="#inicio" className="hover:text-accent transition-colors">Início</Link>
              </li>
              <li>
